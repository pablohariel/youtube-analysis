...
var DeleteUserService = /** @class */ (function () {
    ...
    DeleteUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var checkUserExists, deletedUser;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, connection_1.prisma.user.findUnique({
                            where: {
                                id: id
                            }
                        })];
                    case 1:
                        ...
                        return [4 /*yield*/, connection_1.prisma.analysis.deleteMany({
                                where: {
                                    userId: id
                                }
                            })];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, connection_1.prisma.user["delete"]({
                                where: {
                                    id: id
                                },
                                select: {
