...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, passwordMatched, _b, _c, secret, expiresIn, token, filteredUser;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        passwordMatched = _d.sent();
                        if (!passwordMatched) {
                            throw new AppError_1.AppError('Incorrect email/password combination.', 401);
                        }
                        _b = auth_1["default"].jwt, _c = _b.secret, secret = _c === void 0 ? '' : _c, expiresIn = _b.expiresIn;
                        token = jsonwebtoken_1.sign({ id: user.id }, secret, { expiresIn: expiresIn });
                        filteredUser = {
                            id: user.id,
